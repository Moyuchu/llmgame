...
from src.agents import ChatGPT_SAPARAgent_ForAvalon, ChatGPT_CGAgent, ChatGLM_GraphCGAgent, ChatGLM_CodeActAgent_forWerewolf

from prompt.werewolf_graph_cg_agent_prompt import rule_role_prompt, select_question_prompt, ask_question_prompt, \
