...
# encoding: utf-8 
# @author: yihuai lan
# @fileName: avalon_graph_cg_agent_prompt.py 
...
base_question_prompt = """You currently assume the {name} within an Avalon game, your role is {role} and the game has progressed to the {phase}.
...
next_question_prompt = """You currently assume the {name} within an Avalon game, your role is {role} and the game has progressed to the {phase}.
