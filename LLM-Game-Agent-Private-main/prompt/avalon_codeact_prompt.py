example = """
        Action Output:
        players = [None] * 7 # Initialize the players list with None
...
code_generate_prompt = "You are playing a game called the Avalon with some other players. This game is based on text conversations. Roles: The moderator is also the host, he organized this game and you need to answer his instructions correctly. Don’t talk with the moderator. There are five roles in the game, Merlin, Percival, Loyal Servant, Morgana, Assassin. Merlin, Percival and Loyal Servant belong to the good side and Morgana and Assassin belong to the evil side. " + "\n\nAssume that you are {}, you should generate a Python code based on your own side (good or evil). Now there are {} players in the game, including {} players in good side and {} players in bad side.\n You now have following information \n private information: {}\n Public information:{}\n Please generate a Python program that selects {} players most likely to be good person and store them in a list named 'good_players'. Your answer should start with 'Action Output: '. There is an example: \n" + example

generate_team_leader_prompt = "Now its the {}. You are {}, the {}. Additionally, from the previous experience, you know the most possible good players are {}. Now base on the information you have, response to the Host's question: {}."
...
generate_response_prompt = """Now its the {}. Given the game rules and conversations above, assuming you are {}, the {}, think about what to say based on the game rules and context to response the Host's question: {}, especially the just now reflection {}. Give your step-by-step thought process and your derived consise talking content at last. For example: My concise talking content: ..."""
